package com.example.tintinmj.sunshine.app.data;

/**
 * Created by tintinmj on 11-10-2014.
 */
...
public class WeatherContract {
    ...
    // for the content authority is the package name for the app, which is guaranteed to be
    // unique on the device
    public static final String CONTENT_AUTHORITY = "com.example.tintinmj.sunshine.app";
    ...
    // possible paths (appended to base content URI possible URI's)
